...
class SerialFrameUI(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title='SerialSend', pos=wx.DefaultPosition,
...
class SerialFrame(SerialFrameUI):
    def __init__(self, parent=None):
        ...
        self.s = self.m_txtInput.GetValue()
        self.Ser = Serial()
    ...
    def on_btnSend_clicked(self, event):
        self.s = self.m_txtInput.GetValue()
        #self.s.encode('utf-8')
        self.Ser.write(str(self.s))

    def on_btnClear_clicked(self, event):
        self.m_txtMain.Clear()
        self.m_txtInput.Clear()
